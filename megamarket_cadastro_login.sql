...
CREATE TABLE `cadastro_login` (
  ...
  KEY `fk_CADASTRO_LOGIN_funcionario1_idx` (`funcionario_cod`),
  CONSTRAINT `fk_CADASTRO_LOGIN_funcionario1` FOREIGN KEY (`funcionario_cod`) REFERENCES `funcionario` (`cod`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-11-13 12:18:01
